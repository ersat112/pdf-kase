      ...
      <View style={styles.container}>
        <View style={styles.heroCard}>
          ...
          <Text style={styles.heroSubtitle}>
            Tarama, düzenleme, kaşe ve export akışların cihazında kalır. Test
            sürümünde mock hesap ile hızlı giriş yapabilirsin.
          </Text>

          <View style={styles.heroPillRow}>
            <InfoPill label="Local-first" tone="success" />
            <InfoPill label="Mock auth hazır" tone="accent" />
            <InfoPill label="Development build" />
          </View>
        </View>

        <View style={styles.quickAccessCard}>
          <View style={styles.quickAccessTextWrap}>
            <Text style={styles.quickAccessTitle}>Demo hesap hazır</Text>
            <Text style={styles.quickAccessText}>
              Kapalı testte hızlı giriş için hazır oturum bilgilerini tek
              dokunuşla doldur.
            </Text>
          </View>
          ...
          >
            <Text style={styles.secondaryButtonText}>Demo hesabı doldur</Text>
          </Pressable>
        </View>
        ...
        <View style={styles.formCard}>
          ...
          <View style={styles.helperRow}>
            <Text style={styles.helperText}>
              Demo hesapla hızlı test yapabilir veya kayıt ekranından yeni mock
